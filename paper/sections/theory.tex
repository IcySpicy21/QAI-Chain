...
This section states what we can actually prove about the controller under assumptions that are stronger than deployment reality. The point is to connect the simulation behavior to a small set of formal knobs---not to pretend the assumptions cover every datacenter failure mode.
...
Taken together, these results provide a conditional explanation for the observed behavior of the combined policy (quantum-inspired uncertainty-gated fallback + shield + risk shaping): when shield completeness and calibration assumptions are approximately satisfied, degradation remains controlled and safety behavior is more stable under shift.
