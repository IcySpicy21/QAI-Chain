...
This section formalizes the mechanism-level guarantees of the proposed controller under explicit assumptions. The intent is to clarify why the architecture behaves as observed in simulation, not to claim assumption-free optimality theorems for all deployment settings.
