...
The intent is pragmatic: make it hard to ``hand-wave'' a result into the paper. Figures and tables should be regenerated from tracked artifacts, not copy-pasted from a scratch notebook \cite{wilson2017good,stodden2016enhancing}.
